...
// v2: añade el intent "weather" (clima vía Open-Meteo en el cliente).
// Se conserva command.v1.ts para comparar/volver atrás (ver README).

export const VERSION = "command.v2";
